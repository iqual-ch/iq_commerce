...
/**
 * Configure IQ Commerce settings for this site.
 *
...
class IqCommerceSettingsForm extends ConfigFormBase {
  ...
  public static function getIqCommerceSettings() {
    ...
    $iqCommerceSettingsConfig = $language_manager->getLanguageConfigOverride($current_language, 'iq_commerce.settings');
    return [
      'header' => $iqCommerceSettingsConfig->get('header') != NULL ?
      $iqCommerceSettingsConfig->get('header') :
      [
        'value' => '<b>' . t("Commerce Store.") . '</b>',
        'format' => 'pagedesigner',
      ],
      'footer' => $iqCommerceSettingsConfig->get('footer') != NULL ?
      $iqCommerceSettingsConfig->get('footer') :
      [
