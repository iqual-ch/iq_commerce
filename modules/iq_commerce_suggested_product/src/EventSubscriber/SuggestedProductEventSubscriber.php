...
namespace Drupal\iq_commerce_suggested_product\EventSubscriber;

use Drupal\iq_commerce\Event\IqCommerceCartEvents;
use Symfony\Component\EventDispatcher\EventSubscriberInterface;
use Drupal\iq_commerce\Event\IqCommerceAfterCartAddEvent;

class SuggestedProductEventSubscriber implements EventSubscriberInterface {
  ...
  public function suggestRelatedProducts(IqCommerceAfterCartAddEvent $event) {
    ...
    \Drupal::logger('iq_commerce')->notice('Products suggested after');
